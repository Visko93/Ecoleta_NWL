...
const Detail = () => {
  ...
  const handleWhatsapp = () => {
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho Interesse na entrega de material Reciclável`)
  }

  const handleComposeMail = () => {
      MailComposer.composeAsync({
        recipients: [data.point.email],
        subject: `Interesse na entrega de residuos`,        
      });    
  }
