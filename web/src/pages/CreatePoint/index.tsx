...
const CreatePoint = () => {
  ...
  const [initialPositions, setInitialPositions] = useState<[number, number]>([0, 0]);
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(position => {
      ...
      setInitialPositions([latitude, longitude]);
    });
  }, []);
  ...
  return (
    <div id="page-create-point">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Map center={initialPositions} zoom={15} onClick={handleMapClick}>
              <TileLayer 
